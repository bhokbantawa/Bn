...
from gatet0 import Tele  # <-- now points to gatet0.py
...
# ==========================================
TOKEN = '8009433933:AAGmyxoYrfVMrPJUAGNKu0q-9K1BhPsLRAE'
ADMIN_ID = '7622959338'
...
declined_keys = ["cannot be processed", "CARD_DECLINED", "Your card was declined.", "generic_decline", "declined", "cannot be processed"]
...
otp_keys = ["could not verify your payment", "action_required", "verifying", "call_next_method", "requires_source_action", "requires_action", "3d_secure", "authenticate"]
